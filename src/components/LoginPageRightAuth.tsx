          ...
          <div className="border-b border-gray flex flex-col md:p-4 md:pt-2 p-2  items-center justify-center ">
            ...
            <div className="border-gray bg-[#FAFAFA] border rounded-lg flex">
              <button
                ...
                className={`md:w-[300px] px-14 md:py-4 py-1 font-inter md:text-[1.2rem] rounded-lg border-[#E9ebea] font-semibold ${
                  selected
                    ? "bg-primaryBlue text-[#ffffff] border-[#125abe] "
              ...
              <button
                ...
                className={` w-40 md:w-[300px] md:py-3 py-2 md:text-[1.2rem] border-[#E9ebea] text-center  rounded-lg duration-300 font-semibold ${
                  !selected
                    ? "bg-primaryBlue text-[#ffffff] border-[#125abe]"
                    : "text-[#414651] hover:bg-gray-100"
                }  `}
